                ...
                <div className="flex flex-col px-6 mx-auto items-left lg:px-11 lg:w-screen-lg">
                    ...
                    <section className="pt-2 pb-5 text-true-gray-400" dark="text-true-gray-500">
                        ...
                        <p className="space-x-1 md:space-x-2 text-[10px] mt-2 text-true-gray-300">
                                    <span><a className="hover:underline hover:text-true-gray-400" dark="text-true-gray-700 hover:text-true-gray-400" href="http://beian.miit.gov.cn/" rel="noopener noreferrer" target="_blank">苏ICP备 2020111837 号</a></span>
                                    <span><a className="hover:underline hover:text-true-gray-400" dark="text-true-gray-700 hover:text-true-gray-400" href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=32011202000528" rel="noopener noreferrer" target="_blank">苏公网安备 32010202011188 号</a></span>
                                </p>
                    </section>
                </div>
            </footer>
